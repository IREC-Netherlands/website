...
description: This is a small tutorial on how to write in Markdown file.
date: '2025-12-30'
categories:
  - events
  - tutorial
...
Unless the [paragraph](#paragraphs) is in a list, don’t indent paragraphs with spaces or tabs.

:::important
If you need to indent paragraphs in the output, see the section on how to [indent (tab)](https://www.markdownguide.org/hacks/#indent-tab).
:::
...
```md
This is the first line. There are two spaces after me.  
...
Result of each of the block:  
1. First item
2. Second item
3. Third item
4. Fourth item  

Lists can be nested to introduce new level of lists.
...
To create code blocks, use 3 backticks to wrap the code
...
The rendered output looks like this, try hover over it:  
My favorite search engine is [Duck Duck Go](https://duckduckgo.com "The best search engine for privacy").
...
![The San Juan Mountains are beautiful!][2]

[2]: <https://mdg.imgix.net/assets/images/san-juan-mountains.jpg?auto=format&fit=clip&q=40&w=1080> "San Juan Mountains"
